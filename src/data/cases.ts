...
export const CASES: CaseTemplate[] = [
    // CASE 1: JULIANA (Narrative Tutorial)
    {
        id: "case_juliana_01",
        difficulty: "medium",
    ...
    // CASE 2: POLITICS (Caso PROGEN - Crisis Energética)
    {
        id: "case_progen_01",
        difficulty: "easy",
    ...
    // CASE 3: CORPORATE (Caso Sinohydro - Ina Papers)
    {
    ...
    // CASE 4: CRIME (Los 4 de las Malvinas - Crimen de Estado)
    {
        id: "case_malvinas_01",
        difficulty: "hard",
